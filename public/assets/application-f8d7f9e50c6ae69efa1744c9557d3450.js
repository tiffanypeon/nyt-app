...
var fullStoriesTemplate = $.get('templates/full_stories.html')
...
function storyParams(story) {
  return {
    ...
    image: 'https://graphics8.nytimes.com/' + story.images[0].types[0].content,
...
function generateDiv(story) {
  ...
  var inner_div = _.template(fullStoriesTemplate);
  debugger
...
function getStories(data){
  ...
  var assetsArray1 = _.filter(collections, function(collection) {
    return collection.assets.length > 0
  })
  var assetsArray2 = _.pluck(assetsArray1, 'assets')
  var assets = _.flatten(assetsArray2)
